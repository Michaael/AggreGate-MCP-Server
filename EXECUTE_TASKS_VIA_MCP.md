# Выполнение задач через call_mcp_tool
...
### Шаг 3: Создание первого пользователя (user1)
...
### Шаг 4: Создание второго пользователя (user2)
...
### Шаг 5: Создание виртуального устройства для user2
...
**⚠️ ВАЖНО:** Настройка доступа к устройствам другого пользователя требует использования Actions через веб-интерфейс AggreGate или через более сложные операции.
