...
public class VarianceFunction extends AbstractFunction
{
  public VarianceFunction()
  {
    super("variance", Function.GROUP_MATH, "DataTable table [, String field]", "Double", Cres.get().getString("fDescDispersion"));
  }
  ...
  public Object execute(Evaluator evaluator, EvaluationEnvironment environment, Object... parameters) throws EvaluationException
  {
    ...
    return variance.evaluate(seriesData);
  }
}
