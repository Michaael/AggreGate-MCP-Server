...
public class LinearRegressionFunction extends AbstractFunction
{
  ...
  {
    super("linearRegression", Function.GROUP_MATH, "DataTable table, String xSeriesFieldName, String ySeriesFieldName", "Double", Cres.get().getString("fDescLinearRegression"));
  }
