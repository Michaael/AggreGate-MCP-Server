...
public class StandardErrorMeanFunction extends AbstractFunction {
    public StandardErrorMeanFunction() {
        super("standardError", Function.GROUP_MATH, "DataTable table, String field", "Double", Cres.get().getString("fDescStandardErrorMean"));
    }
    ...
    public Object execute(Evaluator evaluator, EvaluationEnvironment environment, Object... parameters) throws EvaluationException {
        ...
        return standardDeviation.evaluate(seriesData);
    }
}
