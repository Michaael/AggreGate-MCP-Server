...
public class TestContextValidator
{
  ...
  {
    assertTrue(new ExpressionContextValidator(evaluator, new Expression("true"), new Reference()).validate("child.grandChild"));
    assertFalse(new ExpressionContextValidator(evaluator, new Expression("2 == 3"), new Reference()).validate("child.grandChild"));
  }
  ...
  public void testDecoratedContextValidator()
  {
    assertTrue(new DecoratedContextValidator(
        new ExpressionContextValidator(evaluator, new Expression("true"), new Reference()),
    ...
    assertFalse(new DecoratedContextValidator(
            new ExpressionContextValidator(evaluator, new Expression("false"), new Reference()),
            new MaskContextValidator("child")).validate("child"));
