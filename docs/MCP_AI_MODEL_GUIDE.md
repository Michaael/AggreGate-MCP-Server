...
**Для относительной модели ОБЯЗАТЕЛЬНО после создания:**
- Установить `containerType = "devices"` (или другой тип контейнера)
- Установить `objectType = "device"` (или другой тип объекта)
...
// 2. Настройка типа модели (ОБЯЗАТЕЛЬНО!)
{
