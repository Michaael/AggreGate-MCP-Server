...
/**
 * Tool for disabling an alarm
 */
public class DisableAlarmTool implements McpTool {
    @Override
    public String getName() {
        return "aggregate_disable_alarm";
    }
    
    @Override
    public String getDescription() {
        return "Disable an alarm in a context";
    }
    ...
    public JsonNode execute(JsonNode params, ConnectionManager connectionManager) throws McpException {
        ...
        try {
            ...
            // Disable alarm through action or context method
            connection.executeWithTimeout(() -> {
                // Implementation depends on AggreGate API
                // May use executeAction with "disableAlarm" action
                return null;
            }, 60000L);
            
            ObjectNode result = instance.objectNode();
            result.put("success", true);
            result.put("message", "Alarm disabled successfully");
            ...
            throw new McpException(
                ...
                "Failed to disable alarm: " + errorMessage
            );
        }
    }
}
