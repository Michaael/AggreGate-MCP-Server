...
/**
 * Tool for updating event properties
 */
public class UpdateEventTool implements McpTool {
    @Override
    public String getName() {
        return "aggregate_update_event";
    }
    
    @Override
    public String getDescription() {
        return "Update event properties";
    }
    ...
    public JsonNode getInputSchema() {
        ...
        level.put("description", "New level (optional)");
        properties.set("level", level);
        
        ObjectNode historyStorageTime = instance.objectNode();
        historyStorageTime.put("type", "integer");
        historyStorageTime.put("description", "New history storage time in milliseconds (optional)");
    ...
    public JsonNode execute(JsonNode params, ConnectionManager connectionManager) throws McpException {
        ...
        try {
            ...
            // Update event through event definition update or action
