...
/**
 * Tool for listing events in a context
 */
public class ListEventsTool implements McpTool {
    @Override
    public String getName() {
        return "aggregate_list_events";
    }

    @Override
    public String getDescription() {
        return "List all events defined in a context";
    }
    ...
    public JsonNode execute(JsonNode params, ConnectionManager connectionManager) throws McpException {
        ...
        try {
            ...
            List<EventDefinition> events = connection.executeWithTimeout(() -> context.getEventDefinitions(), 60000);
            ...
            if (events != null) {
                for (EventDefinition ed : events) {
                    ...
                    ObjectNode ev = instance.objectNode();
                    ev.put("name", ed.getName() != null ? ed.getName() : "");
                    ev.put("description", ed.getDescription() != null ? ed.getDescription() : "");
                    ev.put("group", ed.getGroup() != null ? ed.getGroup() : "");
                    ev.put("level", ed.getLevel());
                    result.add(ev);
                }
            }
            ...
            throw new McpException(
                ...
                "Failed to list events: " + errorMessage
            );
        }
    }
}
