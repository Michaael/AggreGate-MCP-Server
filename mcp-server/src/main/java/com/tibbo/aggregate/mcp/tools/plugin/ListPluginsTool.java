...
public class ListPluginsTool implements McpTool {
    ...
    public JsonNode execute(JsonNode params, ConnectionManager connectionManager) throws McpException {
        ...
        try {
            ...
            // Plugins in AggreGate are typically accessed through server API or special context
            // For now, return empty array - implementation depends on AggreGate API
