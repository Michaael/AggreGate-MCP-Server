...
/**
 * Tool for enabling a rule
 */
public class EnableRuleTool implements McpTool {
    @Override
    public String getName() {
        return "aggregate_enable_rule";
    }
    
    @Override
    public String getDescription() {
        return "Enable a rule in a context";
    }
    ...
    public JsonNode execute(JsonNode params, ConnectionManager connectionManager) throws McpException {
        ...
        try {
            ...
            // Enable rule through action or context method
            connection.executeWithTimeout(() -> {
                // Implementation depends on AggreGate API
                // May use executeAction with "enableRule" action
                return null;
            }, 60000L);
            
            ObjectNode result = instance.objectNode();
            result.put("success", true);
            result.put("message", "Rule enabled successfully");
            ...
            throw new McpException(
                ...
                "Failed to enable rule: " + errorMessage
            );
        }
    }
}
